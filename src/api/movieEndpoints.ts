...
export const SECTIONS: Sections = {
	movies: {
		sections: [
			{ title: 'Popular on Kdrama links', endpoint: `/movie/popular?api_key=${API_KEY}` },
			{
				title: 'Romance',
	...
	series: {
		sections: [
			{ title: 'Popular on Kdrama links', endpoint: `/tv/popular?api_key=${API_KEY}` },
			{
				title: 'War Politics',
